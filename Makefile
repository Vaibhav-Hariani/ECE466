...
parser: flex bison
	gcc -o parser.out $(CFLAGS) parser/parser.tab.c lexer/lex.yy.c parser/ast_nodes.c parser/parse_output.c

debug_parser: flex bison_debug
	gcc -o parser_debug.out $(CFLAGS) -g parser/parser.tab.c lexer/lex.yy.c parser/ast_nodes.c parser/parse_output.c